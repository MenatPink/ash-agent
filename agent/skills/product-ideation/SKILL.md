...
- `researcher` subagent with `message`: *"Investigate Vercel announcements, product launches, and developer-facing news from roughly the last 60 days. The Vercel Swag Store sells t-shirts, hoodies, mugs, hats, stationery, and tech accessories. Identify Vercel themes, product names, or moments that could inspire new swag designs. Return a short brief with the most promotable themes and concrete naming hooks, with sources."*
